...
export class EditQuestionUseCase {
  ...
  async execute({ authorId, questionId, title, content, atachmentsIds }: EditQuestionUseCaseRequest): Promise<EditQuestionUseCaseResponse> {
    ...
    const questionAttachments = atachmentsIds.map(attachmentId => {
